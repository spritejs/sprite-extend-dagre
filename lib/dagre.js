...
function install(_ref) {
  ...
  var DagreAttr = (_dec = parseValue(parseFloat), _dec2 = parseValue(parseColorString), _dec3 = parseValue(parseFloat), _dec4 = parseValue(parseFloat), _dec5 = parseValue(parseFloat), _dec6 = parseValue(parseInt), (_class = function (_Group$Attr) {
    ...
    (0, _createClass3.default)(DagreAttr, [{
      ...
      get: function get() {
        var labelBg = this.get('labelBg') || this.get('bgcolor') || 'rgba(255,255,255,1)';
        return labelBg;
      }
    }, {
      key: 'align',
  ...
  var Dagre = (_temp = _class2 = function (_Group) {
    ...
    (0, _createClass3.default)(Dagre, [{
      ...
      key: 'updateGraph',
      value: function updateGraph(code, userNodes) {
        var _this3 = this;
